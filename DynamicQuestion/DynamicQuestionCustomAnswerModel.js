...
//
// last edit: 04-19-2016 by Jeremy
//
// History of changes:
//  - 04-19-2016:
//      + Added a checking on the elements' types in the sequence
//      + Added a checking on the value of 'showKeys' for {this: answers}
//      + Added the possibility to add any option in {this: ...}
//  - 04-08-2016:
...
//      + Added a function 'remove' to diaplay off a DOM element
//
...
jqueryWidget: {
    _init: function () {
        ...
        console.log(typeof this.customAnswerModel);
        ...
        for (var el = this.elements.length-1; el >= 0; --el) {
          ...
          /*  // Function
            ...
            if (currentElement.this == "answers") {
              ...
              for (answerIndex in this.orderedAnswers) {
                  ...
                  if (this.answerByPressingAKey != false && currentElement.hasOwnProperty("showKeys")) {
                      // Making sure that the position is well defined
                      assert(currentElement.showKeys.match(/top|bottom|left|right/), 
                             "Unrecognized value for 'showKeys' ('"+currentElement.showKeys+"') in DynamicQuestion");
            ...
            // Otherwise, see if the value of 'this' is a name of an option and try to add it
                ...
                domelements[el].append(t.options[currentElement.this]);
            }
            ...
            // Otherwise, add it if it is a jQuery object
          else if (currentElement instanceof jQuery)
            domelements[el] = currentElement;
            // If not, throw an error
          else 
            assert(1==2, "Unrecognized element in the sequence ('"+currentElement+"') in DynamicQuestion");
