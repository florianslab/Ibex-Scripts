...
//              ,
//              PennController.newImage("alien2.png", 50, 100, "images")
//              ,
        ...
        for (let r in resources) {
            ...
            if (resource && !_preloadedFiles.hasOwnProperty(resource)) {
                ...
                if (controller.toPreload.indexOf(resource) < 0) {
                    ...
                    console.log(_preloadedFiles.hasOwnProperty(resource));
    ...
    class CanvasInstr extends Instruction {
        ...
        run() {
            ...
            for (let o in this.objects) {
                ...
                console.log("Considering "+origin.content+" ("+origin.type+", #"+o+") for canvas");
                // If instruction has not been run yet, run it
                if (!origin.hasBeenRun) {
                    console.log("Running "+origin.content+" ("+origin.type+") from canvas");
                    origin.run();
        ...
        _addObject(instruction, x, y, z) {
            ...
            console.log("CANVAS: before checking");
            ...
            // If instruction has not been run yet, but if CANVAS has been run: run instruction
                ...
                console.log("CANVAS: this been run");
                origin.done = origin.extend("done", function(){
                    origin.element.css({position: "absolute", left: x, top: y, "z-index": z});
                });
                instruction.run();
            }
            console.log("CANVAS: after checking");
        }
        ...
        put(instruction, x, y, z) {
            return this.newMeta(function(){
                console.log("CANVAS: about to add");
